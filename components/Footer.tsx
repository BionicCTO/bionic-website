          ...
          <div className="pb-10 md:pb-16">
            <div>
              ...
              <div className="flex items-center gap-4 mt-8">
                <a href="https://www.linkedin.com/in/amitpatel911" target="_blank" rel="noopener noreferrer" className="text-text-primary hover:text-text-muted transition-colors" aria-label="LinkedIn">
                ...
                <a href="https://x.com/amitpatel911" target="_blank" rel="noopener noreferrer" className="text-text-primary hover:text-text-muted transition-colors" aria-label="X (Twitter)">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
